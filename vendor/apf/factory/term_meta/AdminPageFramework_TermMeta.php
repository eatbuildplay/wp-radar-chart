...
abstract class WP_RadarChartAdminPageFramework_TermMeta_Router extends WP_RadarChartAdminPageFramework_TaxonomyField_Controller {
    }
    abstract class WP_RadarChartAdminPageFramework_TermMeta_Model extends WP_RadarChartAdminPageFramework_TermMeta_Router {
        ...
        private function _getSavedTermMetas($iTermID, array $aFieldsets) {
            $_oMetaData = new WP_RadarChartAdminPageFramework_TermMeta_Model___TermMeta($iTermID, $this->oForm->aFieldsets);
    ...
    abstract class WP_RadarChartAdminPageFramework_TermMeta_View extends WP_RadarChartAdminPageFramework_TermMeta_Model {
    ...
    abstract class WP_RadarChartAdminPageFramework_TermMeta_Controller extends WP_RadarChartAdminPageFramework_TermMeta_View {
    }
    abstract class WP_RadarChartAdminPageFramework_TermMeta extends WP_RadarChartAdminPageFramework_TermMeta_Controller {
        protected $_sStructureType = 'term_meta';
        public function __construct($asTaxonomySlug, $sCapability = 'manage_options', $sTextDomain = 'wp-radar-chart') {
