...
abstract class WP_RadarChartAdminPageFramework_PostType_Router extends WP_RadarChartAdminPageFramework_Factory {
    ...
    abstract class WP_RadarChartAdminPageFramework_PostType_Model extends WP_RadarChartAdminPageFramework_PostType_Router {
        public function __construct($oProp) {
            parent::__construct($oProp);
            ...
            if ($this->oProp->bIsAdmin) {
                ...
                if ($this->oProp->sCallerPath) {
                    new WP_RadarChartAdminPageFramework_PostType_Model__FlushRewriteRules($this);
                }
            }
        }
        ...
        public function _replyToRegisterPostType() {
            ...
            new WP_RadarChartAdminPageFramework_PostType_Model__SubMenuOrder($this);
        }
    ...
    abstract class WP_RadarChartAdminPageFramework_PostType_View extends WP_RadarChartAdminPageFramework_PostType_Model {
        public function __construct($oProp) {
            parent::__construct($oProp);
            if ($this->oProp->bIsAdmin) {
        ...
        public function _replyToPrintStyle() {
            ...
            if (!empty($this->oProp->sStyle)) {
                echo "<style type='text/css' id='wp-radar-chart-style-post-type'>" . $this->oProp->sStyle . "</style>";
            }
        }
    ...
    abstract class WP_RadarChartAdminPageFramework_PostType_Controller extends WP_RadarChartAdminPageFramework_PostType_View {
    ...
    abstract class WP_RadarChartAdminPageFramework_PostType extends WP_RadarChartAdminPageFramework_PostType_Controller {
        protected $_sStructureType = 'post_type';
        public function __construct($sPostType, $aArguments = array(), $sCallerPath = null, $sTextDomain = 'wp-radar-chart') {
            if (empty($sPostType)) {
                return;
            }
            $_sProprtyClassName = isset($this->aSubClassNames['oProp']) ? $this->aSubClassNames['oProp'] : 'WP_RadarChartAdminPageFramework_Property_' . $this->_sStructureType;
            ...
            $this->oProp->sPostType = WP_RadarChartAdminPageFramework_WPUtility::sanitizeSlug($sPostType);
            $this->oProp->aPostTypeArgs = $aArguments;
        ...
        private function _getCallerScriptPath($sCallerPath) {
            ...
            $_sPageNow = WP_RadarChartAdminPageFramework_Utility::getElement($GLOBALS, 'pagenow');
            if (in_array($_sPageNow, array('edit.php', 'post.php', 'post-new.php', 'plugins.php', 'tags.php', 'edit-tags.php', 'term.php'))) {
                return WP_RadarChartAdminPageFramework_Utility::getCallerScriptPath(__FILE__);
            }
            return null;
        }
    }
