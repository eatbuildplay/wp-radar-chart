...
abstract class WP_RadarChartAdminPageFramework_Widget_Router extends WP_RadarChartAdminPageFramework_Factory {
    ...
    abstract class WP_RadarChartAdminPageFramework_Widget_Model extends WP_RadarChartAdminPageFramework_Widget_Router {
        ...
        public function _replyToRegisterWidget() {
            ...
            $GLOBALS['wp_widget_factory']->widgets[$this->oProp->sClassName] = new WP_RadarChartAdminPageFramework_Widget_Factory($this, $this->oProp->sWidgetTitle, $this->oUtil->getAsArray($this->oProp->aWidgetArguments));
            $this->oProp->oWidget = $GLOBALS['wp_widget_factory']->widgets[$this->oProp->sClassName];
        }
    }
    abstract class WP_RadarChartAdminPageFramework_Widget_View extends WP_RadarChartAdminPageFramework_Widget_Model {
    ...
    abstract class WP_RadarChartAdminPageFramework_Widget_Controller extends WP_RadarChartAdminPageFramework_Widget_View {
    ...
    abstract class WP_RadarChartAdminPageFramework_Widget extends WP_RadarChartAdminPageFramework_Widget_Controller {
        protected $_sStructureType = 'widget';
        public function __construct() {
            $_sThisClassName = get_class($this);
            $_bAssumedAsWPWidget = 0 === func_num_args();
            $_aDefaults = array('', array(), 'edit_theme_options', 'wp-radar-chart');
