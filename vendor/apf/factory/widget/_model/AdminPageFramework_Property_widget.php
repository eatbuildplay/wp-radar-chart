...
class WP_RadarChartAdminPageFramework_Property_widget extends WP_RadarChartAdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sCapability = 'manage_options', $sTextDomain = 'wp-radar-chart', $sStructureType) {
