...
abstract class WP_RadarChartAdminPageFramework_NetworkAdmin extends WP_RadarChartAdminPageFramework {
    ...
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_network', $sTextDomain = 'wp-radar-chart') {
        if (!$this->_isInstantiatable()) {
            return;
        }
        $sCallerPath = $sCallerPath ? $sCallerPath : WP_RadarChartAdminPageFramework_Utility::getCallerScriptPath(__FILE__);
        parent::__construct($sOptionKey, $sCallerPath, $sCapability, $sTextDomain);
        new WP_RadarChartAdminPageFramework_Model_Menu__RegisterMenu($this, 'network_admin_menu');
    }
    ...
    static public function getOption($sOptionKey, $asKey = null, $vDefault = null) {
        return WP_RadarChartAdminPageFramework_WPUtility::getSiteOption($sOptionKey, $asKey, $vDefault);
    }
    }
