...
class WP_RadarChartAdminPageFramework_Property_network_admin_page extends WP_RadarChartAdminPageFramework_Property_admin_page {
    ...
    protected function _getOptions() {
        return $this->addAndApplyFilter($this->getElement($GLOBALS, array('aWP_RadarChartAdminPageFramework', 'aPageClasses', $this->sClassName)), 'options_' . $this->sClassName, $this->sOptionKey ? get_site_option($this->sOptionKey, array()) : array());
    }
