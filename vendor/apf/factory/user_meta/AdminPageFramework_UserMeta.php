...
abstract class WP_RadarChartAdminPageFramework_UserMeta_Router extends WP_RadarChartAdminPageFramework_Factory {
    ...
    abstract class WP_RadarChartAdminPageFramework_UserMeta_Model extends WP_RadarChartAdminPageFramework_UserMeta_Router {
        public function _replyToGetSavedFormData() {
            $_iUserID = isset($GLOBALS['profileuser']->ID) ? $GLOBALS['profileuser']->ID : 0;
            $_oMetaData = new WP_RadarChartAdminPageFramework_UserMeta_Model___UserMeta($_iUserID, $this->oForm->aFieldsets);
    ...
    abstract class WP_RadarChartAdminPageFramework_UserMeta_View extends WP_RadarChartAdminPageFramework_UserMeta_Model {
    ...
    abstract class WP_RadarChartAdminPageFramework_UserMeta_Controller extends WP_RadarChartAdminPageFramework_UserMeta_View {
    ...
    abstract class WP_RadarChartAdminPageFramework_UserMeta extends WP_RadarChartAdminPageFramework_UserMeta_Controller {
        protected $_sStructureType = 'user_meta';
        public function __construct($sCapability = 'read', $sTextDomain = 'wp-radar-chart') {
