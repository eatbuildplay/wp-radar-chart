...
abstract class WP_RadarChartAdminPageFramework_CustomSubmitFields extends WP_RadarChartAdminPageFramework_FrameworkUtility {
    public $aPost = array();
    public $sInputID;
    ...
    class WP_RadarChartAdminPageFramework_ExportOptions extends WP_RadarChartAdminPageFramework_CustomSubmitFields {
        public $sClassName;
        public $sFileName;
        public $sFormatType;
        public $bIsDataSet;
            ...
            switch (strtolower($sFormatType)) {
                case 'text':
                    if (in_array(gettype($vData), array('array', 'object'))) {
                        echo WP_RadarChartAdminPageFramework_Debug::get($vData, null, false);
                    }
                    echo $vData;
                    return;
                case 'json':
