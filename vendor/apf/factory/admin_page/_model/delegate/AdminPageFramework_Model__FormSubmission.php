...
abstract class WP_RadarChartAdminPageFramework_Model__FormSubmission_Base extends WP_RadarChartAdminPageFramework_Form_Utility {
    ...
    class WP_RadarChartAdminPageFramework_Model__FormSubmission extends WP_RadarChartAdminPageFramework_Model__FormSubmission_Base {
        public $oFactory;
        public function __construct($oFactory, $aSavedData, $aArguments, $aSectionsets, $aFieldsets) {
            $this->oFactory = $oFactory;
            $this->_handleFormData();
            new WP_RadarChartAdminPageFramework_Model__FormRedirectHandler($oFactory);
        }
        public function _handleFormData() {
            ...
            new WP_RadarChartAdminPageFramework_Model__FormSubmission__Validator($this->oFactory);
