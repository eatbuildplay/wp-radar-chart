...
class WP_RadarChartAdminPageFramework_Model__FormSubmission__Validator_Base extends WP_RadarChartAdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
    ...
    class WP_RadarChartAdminPageFramework_Model__FormSubmission__Validator extends WP_RadarChartAdminPageFramework_Model__FormSubmission__Validator_Base {
        public $oFactory;
        ...
        public function _replyToValidateUserFormInputs($aInputs, $aRawInputs, $aOptions, $oFactory) {
            ...
            $_aClassNames = array('WP_RadarChartAdminPageFramework_Model__FormSubmission__Validator__Link', 'WP_RadarChartAdminPageFramework_Model__FormSubmission__Validator__Redirect', 'WP_RadarChartAdminPageFramework_Model__FormSubmission__Validator__Import', 'WP_RadarChartAdminPageFramework_Model__FormSubmission__Validator__Export', 'WP_RadarChartAdminPageFramework_Model__FormSubmission__Validator__Reset', 'WP_RadarChartAdminPageFramework_Model__FormSubmission__Validator__ResetConfirm', 'WP_RadarChartAdminPageFramework_Model__FormSubmission__Validator__ContactForm', 'WP_RadarChartAdminPageFramework_Model__FormSubmission__Validator__ContactFormConfirm',);
            ...
            try {
                ...
                $_oFormSubmissionFilter = new WP_RadarChartAdminPageFramework_Model__FormSubmission__Validator__Filter($this->oFactory, $aInputs, $aRawInputs, $aOptions, $_aSubmitsInformation);
