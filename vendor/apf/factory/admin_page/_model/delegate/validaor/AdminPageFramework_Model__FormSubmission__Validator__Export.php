...
class WP_RadarChartAdminPageFramework_Model__FormSubmission__Validator__Import extends WP_RadarChartAdminPageFramework_Model__FormSubmission__Validator_Base {
    ...
    private function _importOptions($aStoredOptions, $sPageSlug, $sTabSlug) {
        $_oImport = new WP_RadarChartAdminPageFramework_ImportOptions($_FILES['__import'], $_POST['__import']);
    ...
    class WP_RadarChartAdminPageFramework_Model__FormSubmission__Validator__Export extends WP_RadarChartAdminPageFramework_Model__FormSubmission__Validator__Import {
        public $sActionHookPrefix = 'try_validation_after_';
        ...
        protected function _exportOptions($mData, $sPageSlug, $sTabSlug) {
            $_oExport = new WP_RadarChartAdminPageFramework_ExportOptions($_POST['__export'], $this->oFactory->oProp->sClassName);
