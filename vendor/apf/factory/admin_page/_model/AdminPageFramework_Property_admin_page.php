...
class WP_RadarChartAdminPageFramework_Property_admin_page extends WP_RadarChartAdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $aisOptionKey, $sCapability = 'manage_options', $sTextDomain = 'wp-radar-chart') {
        ...
        $GLOBALS['aWP_RadarChartAdminPageFramework']['aPageClasses'] = $this->getElementAsArray($GLOBALS, array('aWP_RadarChartAdminPageFramework', 'aPageClasses'));
        $GLOBALS['aWP_RadarChartAdminPageFramework']['aPageClasses'][$sClassName] = $oCaller;
