...
class WP_RadarChartAdminPageFramework_View__PageRenderer__PageHeadingTabs extends WP_RadarChartAdminPageFramework_FrameworkUtility {
    public $oFactory;
    public $sPageSlug;
    public $sTag = 'h2';
    ...
    private function _getPageHeadingtabNavigationBar(array $aPages, $sTag, $sCurrentPageSlug) {
        $_oTabBar = new WP_RadarChartAdminPageFramework_TabNavigationBar($aPages, $sCurrentPageSlug, $sTag, array(), array('format' => array($this, '_replyToFormatNavigationTabItem_PageHeadingTab'),));
        $_sTabBar = $_oTabBar->get();
        return $_sTabBar ? "<div class='wp-radar-chart-page-heading-tab'>" . $_sTabBar . "</div>" : '';
    }
