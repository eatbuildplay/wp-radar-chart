...
class WP_RadarChartAdminPageFramework_View__Resource extends WP_RadarChartAdminPageFramework_FrameworkUtility {
    public $oFactory;
    ...
    private function _enqueueAsset_style($asPageStyle) {
        $_oFormatter = new WP_RadarChartAdminPageFramework_Format_PageResource_Style($asPageStyle);
    ...
    private function _enqueueAsset_script($asPageScript) {
        $_oFormatter = new WP_RadarChartAdminPageFramework_Format_PageResource_Script($asPageScript);
