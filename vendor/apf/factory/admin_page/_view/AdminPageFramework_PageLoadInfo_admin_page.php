...
class WP_RadarChartAdminPageFramework_PageLoadInfo_admin_page extends WP_RadarChartAdminPageFramework_PageLoadInfo_Base {
    ...
    public static function instantiate($oProp, $oMsg) {
        ...
        self::$_oInstance = new WP_RadarChartAdminPageFramework_PageLoadInfo_admin_page($oProp, $oMsg);
        return self::$_oInstance;
    }
