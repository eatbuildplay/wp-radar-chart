...
abstract class WP_RadarChartAdminPageFramework_Router extends WP_RadarChartAdminPageFramework_Factory {
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'wp-radar-chart') {
        $_sPropertyClassName = isset($this->aSubClassNames['oProp']) ? $this->aSubClassNames['oProp'] : 'WP_RadarChartAdminPageFramework_Property_' . $this->_sStructureType;
    ...
    public function _replyToLoadComponentsForAjax() {
        ...
        new WP_RadarChartAdminPageFramework_Model_Menu__RegisterMenu($this, 'pseudo_admin_menu');
    ...
    abstract class WP_RadarChartAdminPageFramework_Model_Form extends WP_RadarChartAdminPageFramework_Router {
        public $aFieldErrors;
        ...
        public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'wp-radar-chart') {
            ...
            new WP_RadarChartAdminPageFramework_Model__FormEmailHandler($this);
        ...
        public function _replyToHandleSubmittedFormData($aSavedData, $aArguments, $aSectionsets, $aFieldsets) {
            new WP_RadarChartAdminPageFramework_Model__FormSubmission($this, $aSavedData, $aArguments, $aSectionsets, $aFieldsets);
        }
    ...
    abstract class WP_RadarChartAdminPageFramework_View_Form extends WP_RadarChartAdminPageFramework_Model_Form {
    ...
    abstract class WP_RadarChartAdminPageFramework_Controller_Form extends WP_RadarChartAdminPageFramework_View_Form {
        ...
        public function getValue() {
            ...
            return WP_RadarChartAdminPageFramework_WPUtility::getOption($this->oProp->sOptionKey, empty($_aParams) ? null : $_aDimensionalKeys, $_mDefault, $this->getSavedOptions() + $this->oForm->getDefaultFormValues());
        }
    ...
    abstract class WP_RadarChartAdminPageFramework_Model_Page extends WP_RadarChartAdminPageFramework_Controller_Form {
        public function _replyToFinalizeInPageTabs() {
            ...
            foreach ($this->oProp->aPages as $_sPageSlug => $_aPage) {
                ...
                $_oFormatter = new WP_RadarChartAdminPageFramework_Format_InPageTabs($this->oProp->aInPageTabs[$_sPageSlug], $_sPageSlug, $this);
    ...
    abstract class WP_RadarChartAdminPageFramework_View_Page extends WP_RadarChartAdminPageFramework_Model_Page {
        public function _replyToEnablePageMetaBoxes() {
            new WP_RadarChartAdminPageFramework_View__PageMetaboxEnabler($this);
        }
        public function _replyToEnqueuePageAssets() {
            new WP_RadarChartAdminPageFramework_View__Resource($this);
        }
        ...
        protected function _renderPage($sPageSlug, $sTabSlug = null) {
            $_oPageRenderer = new WP_RadarChartAdminPageFramework_View__PageRenderer($this, $sPageSlug, $sTabSlug);
            $_oPageRenderer->render();
        }
    }
    abstract class WP_RadarChartAdminPageFramework_Controller_Page extends WP_RadarChartAdminPageFramework_View_Page {
    ...
    abstract class WP_RadarChartAdminPageFramework_Model_Menu extends WP_RadarChartAdminPageFramework_Controller_Page {
        public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'wp-radar-chart') {
            parent::__construct($sOptionKey, $sCallerPath, $sCapability, $sTextDomain);
            new WP_RadarChartAdminPageFramework_Model_Menu__RegisterMenu($this);
        }
    }
    abstract class WP_RadarChartAdminPageFramework_View_Menu extends WP_RadarChartAdminPageFramework_Model_Menu {
    }
    abstract class WP_RadarChartAdminPageFramework_Controller_Menu extends WP_RadarChartAdminPageFramework_View_Menu {
        ...
        public function addSubMenuLink(array $aSubMenuLink) {
            ...
            $_oFormatter = new WP_RadarChartAdminPageFramework_Format_SubMenuLink($aSubMenuLink, $this, count($this->oProp->aPages) + 1);
        ...
        public function addSubMenuPage(array $aSubMenuPage) {
            ...
            $_oFormatter = new WP_RadarChartAdminPageFramework_Format_SubMenuPage($aSubMenuPage, $this, count($this->oProp->aPages) + 1);
            $_aSubMenuPage = $_oFormatter->get();
            $this->oProp->aPages[$_aSubMenuPage['page_slug']] = $_aSubMenuPage;
        }
    }
    abstract class WP_RadarChartAdminPageFramework_Model extends WP_RadarChartAdminPageFramework_Controller_Menu {
    }
    abstract class WP_RadarChartAdminPageFramework_View extends WP_RadarChartAdminPageFramework_Model {
        public function content($sContent) {
            return $sContent;
        }
    }
    abstract class WP_RadarChartAdminPageFramework_Controller extends WP_RadarChartAdminPageFramework_View {
        ...
        public function setAdminNotice($sMessage, $sClassSelector = 'error', $sID = '') {
            ...
            new WP_RadarChartAdminPageFramework_AdminNotice($this->oProp->aAdminNotices[$sID]['sMessage'], $this->oProp->aAdminNotices[$sID]['aAttributes'], array('should_show' => array($this, 'isInThePage'),));
        }
        ...
        static public function getOption($sOptionKey, $asKey = null, $vDefault = null) {
            return WP_RadarChartAdminPageFramework_WPUtility::getOption($sOptionKey, $asKey, $vDefault);
        }
    }
    abstract class WP_RadarChartAdminPageFramework extends WP_RadarChartAdminPageFramework_Controller {
        protected $_sStructureType = 'admin_page';
        public function __construct($isOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'wp-radar-chart') {
        ...
        private function _getCallerPath($sCallerPath) {
            ...
            $_sCalllerPath = in_array($GLOBALS['pagenow'], array('plugins.php',)) || isset($_GET['page']) ? WP_RadarChartAdminPageFramework_Utility::getCallerScriptPath(__FILE__) : null;
