...
class WP_RadarChartAdminPageFramework_Property_page_meta_box extends WP_RadarChartAdminPageFramework_Property_post_meta_box {
    ...
    public function __construct($oCaller, $sClassName, $sCapability = 'manage_options', $sTextDomain = 'wp-radar-chart', $sStructureType = 'page_meta_box') {
        unset($this->oAdminPage, $this->aHelpTabs);
        parent::__construct($oCaller, $sClassName, $sCapability, $sTextDomain, $sStructureType);
        $GLOBALS['aWP_RadarChartAdminPageFramework']['aMetaBoxForPagesClasses'] = $this->getElementAsArray($GLOBALS, array('aWP_RadarChartAdminPageFramework', 'aMetaBoxForPagesClasses'));
        $GLOBALS['aWP_RadarChartAdminPageFramework']['aMetaBoxForPagesClasses'][$sClassName] = $oCaller;
    }
    ...
    private function _getOwnerObjectOfPage($sPageSlug) {
        $_aPageClasses = $this->getElementAsArray($GLOBALS, array('aWP_RadarChartAdminPageFramework', 'aPageClasses'));
