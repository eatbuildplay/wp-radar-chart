...
abstract class WP_RadarChartAdminPageFramework_Factory_Router {
    public $oProp;
    public $oDebug;
    public $oUtil;
    public $oMsg;
    ...
    protected $oHelpPane;
    protected $oLink;
    protected $_aSubClassPrefixes = array('oForm' => 'WP_RadarChartAdminPageFramework_Form_', 'oPageLoadInfo' => 'WP_RadarChartAdminPageFramework_PageLoadInfo_', 'oResource' => 'WP_RadarChartAdminPageFramework_Resource_', 'oHelpPane' => 'WP_RadarChartAdminPageFramework_HelpPane_', 'oLink' => 'WP_RadarChartAdminPageFramework_Link_',);
    private $_aSubClassNames = array('oProp' => null, 'oDebug' => 'WP_RadarChartAdminPageFramework_Debug', 'oUtil' => 'WP_RadarChartAdminPageFramework_FrameworkUtility', 'oMsg' => 'WP_RadarChartAdminPageFramework_Message', 'oForm' => null, 'oPageLoadInfo' => null, 'oResource' => null, 'oHelpPane' => null, 'oLink' => null,);
    ...
    private function _triggerUndefinedMethodWarning($sMethodName) {
        trigger_error(WP_RadarChartAdminPageFramework_Registry::NAME . ': ' . sprintf(__('The method is not defined: %1$s', $this->oProp->sTextDomain), $sMethodName), E_USER_WARNING);
    }
    public function __toString() {
        return WP_RadarChartAdminPageFramework_FrameworkUtility::getObjectInfo($this);
    }
    ...
    abstract class WP_RadarChartAdminPageFramework_Factory_Model extends WP_RadarChartAdminPageFramework_Factory_Router {
        public function __construct($oProp) {
    ...
    abstract class WP_RadarChartAdminPageFramework_Factory_View extends WP_RadarChartAdminPageFramework_Factory_Model {
        public function __construct($oProp) {
            parent::__construct($oProp);
            new WP_RadarChartAdminPageFramework_Factory_View__SettingNotice($this, $this->oProp->sSettingNoticeActionHook);
        }
    ...
    abstract class WP_RadarChartAdminPageFramework_Factory_Controller extends WP_RadarChartAdminPageFramework_Factory_View {
    ...
    abstract class WP_RadarChartAdminPageFramework_Factory extends WP_RadarChartAdminPageFramework_Factory_Controller {
    }
