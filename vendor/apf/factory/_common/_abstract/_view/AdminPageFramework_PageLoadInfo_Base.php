...
abstract class WP_RadarChartAdminPageFramework_PageLoadInfo_Base extends WP_RadarChartAdminPageFramework_FrameworkUtility {
    public $oProp;
    public $oMsg;
