...
abstract class WP_RadarChartAdminPageFramework_Property_Base extends WP_RadarChartAdminPageFramework_FrameworkUtility {
    ...
    private function ___setProperties($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sStructureType) {
        ...
        $this->sTextDomain = empty($sTextDomain) ? 'wp-radar-chart' : $sTextDomain;
    ...
    private function ___setGlobals() {
        if (!isset($GLOBALS['aWP_RadarChartAdminPageFramework'])) {
            $GLOBALS['aWP_RadarChartAdminPageFramework'] = array('aFieldFlags' => array());
        }
    }
    ...
    static public function _setLibraryData() {
        self::$_aLibraryData = array('sName' => WP_RadarChartAdminPageFramework_Registry::NAME, 'sURI' => WP_RadarChartAdminPageFramework_Registry::URI, 'sScriptName' => WP_RadarChartAdminPageFramework_Registry::NAME, 'sLibraryName' => WP_RadarChartAdminPageFramework_Registry::NAME, 'sLibraryURI' => WP_RadarChartAdminPageFramework_Registry::URI, 'sPluginName' => '', 'sPluginURI' => '', 'sThemeName' => '', 'sThemeURI' => '', 'sVersion' => WP_RadarChartAdminPageFramework_Registry::getVersion(), 'sDescription' => WP_RadarChartAdminPageFramework_Registry::DESCRIPTION, 'sAuthor' => WP_RadarChartAdminPageFramework_Registry::AUTHOR, 'sAuthorURI' => WP_RadarChartAdminPageFramework_Registry::AUTHOR_URI, 'sTextDomain' => WP_RadarChartAdminPageFramework_Registry::TEXT_DOMAIN, 'sDomainPath' => WP_RadarChartAdminPageFramework_Registry::TEXT_DOMAIN_PATH, 'sNetwork' => '', '_sitewide' => '',);
    ...
    public function __get($sName) {
        ...
        if ('oUtil' === $sName) {
            $this->oUtil = new WP_RadarChartAdminPageFramework_WPUtility;
            return $this->oUtil;
        }
    }
    }
