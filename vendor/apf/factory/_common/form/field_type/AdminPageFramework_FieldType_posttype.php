...
class WP_RadarChartAdminPageFramework_FieldType_checkbox extends WP_RadarChartAdminPageFramework_FieldType {
...
jQuery( document ).ready( function(){
    ...
    jQuery( '{$_sClassSelectorSelectAll}' ).each( function(){
        jQuery( this ).before( '<div class=\"select_all_button_container\" onclick=\"jQuery( this ).selectAllWP_RadarChartAdminPageFrameworkCheckboxes(); return false;\"><a class=\"select_all_button button button-small\">' + jQuery( this ).data( 'select_all_button' ) + '</a></div>' );
    });            
    jQuery( '{$_sClassSelectorSelectNone}' ).each( function(){
        jQuery( this ).before( '<div class=\"select_none_button_container\" onclick=\"jQuery( this ).deselectAllWP_RadarChartAdminPageFrameworkCheckboxes(); return false;\"><a class=\"select_all_button button button-small\">' + jQuery( this ).data( 'select_none_button' ) + '</a></div>' );
    });
});
JAVASCRIPTS;
    ...
    private function _getSelectButtonClassSelectors(array $aFieldTypeSlugs, $sDataAttribute = 'select_all_button') {
        ...
        foreach ($aFieldTypeSlugs as $_sSlug) {
            ...
            $_aClassSelectors[] = '.wp-radar-chart-checkbox-container-' . $_sSlug . "[data-{$sDataAttribute}]";
        }
        return implode(',', $_aClassSelectors);
    }
    protected function getStyles() {
        return ".select_all_button_container, .select_none_button_container{display: inline-block;margin-bottom: 0.4em;}.wp-radar-chart-checkbox-label {margin-top: 0.1em;}.wp-radar-chart-field input[type='checkbox' ] {margin-right: 0.5em;} .wp-radar-chart-field-checkbox .wp-radar-chart-input-label-container {padding-right: 1em;}.wp-radar-chart-field-checkbox .wp-radar-chart-input-label-string{display: inline; }";
    }
    ...
    class WP_RadarChartAdminPageFramework_FieldType_posttype extends WP_RadarChartAdminPageFramework_FieldType_checkbox {
        ...
        protected function getStyles() {
            ...
            return $_sParentStyles . ".wp-radar-chart-field input[type='checkbox'] {margin-right: 0.5em;} .wp-radar-chart-field-posttype .wp-radar-chart-input-label-container {padding-right: 1em;}";
        }
        protected function getField($aField) {
