...
class WP_RadarChartAdminPageFramework_FieldType_radio extends WP_RadarChartAdminPageFramework_FieldType {
    public $aFieldTypeSlugs = array('radio');
    protected $aDefaultKeys = array('label' => array(), 'attributes' => array(),);
    protected function getStyles() {
        return ".wp-radar-chart-field input[type='radio'] {margin-right: 0.5em;} .wp-radar-chart-field-radio .wp-radar-chart-input-label-container {padding-right: 1em;} .wp-radar-chart-field-radio .wp-radar-chart-input-container {display: inline;} .wp-radar-chart-field-radio .wp-radar-chart-input-label-string{display: inline; }";
    }
...
jQuery( document ).ready( function(){
    jQuery( 'input[type=radio][data-id=\"{$sInputID}\"]' ).change( function() {
        ...
        jQuery( this ).closest( '.wp-radar-chart-field' ).find( 'input[type=radio][data-id=\"{$sInputID}\"]' ).attr( 'checked', false );
