...
class WP_RadarChartAdminPageFramework_FieldType_submit extends WP_RadarChartAdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".wp-radar-chart-field input[type='submit'] {margin-bottom: 0.5em;}";
    }
    ...
    private function _getLabelContainerAttributes(array $aField) {
        return array('style' => $aField['label_min_width'] || '0' === ( string )$aField['label_min_width'] ? "min-width:" . $this->getLengthSanitized($aField['label_min_width']) . ";" : null, 'class' => 'wp-radar-chart-input-label-container' . ' wp-radar-chart-input-button-container' . ' wp-radar-chart-input-container',);
    }
    ...
    class WP_RadarChartAdminPageFramework_FieldType_export extends WP_RadarChartAdminPageFramework_FieldType_submit {
