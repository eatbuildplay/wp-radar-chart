...
class WP_RadarChartAdminPageFramework_FieldType_import extends WP_RadarChartAdminPageFramework_FieldType_submit {
    ...
    protected function getStyles() {
        return ".wp-radar-chart-field-import input {margin-right: 0.5em;}.wp-radar-chart-field-import label,.form-table td fieldset.wp-radar-chart-fieldset .wp-radar-chart-field-import label { display: inline; }";
    }
