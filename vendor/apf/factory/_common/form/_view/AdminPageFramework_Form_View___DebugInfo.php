...
class WP_RadarChartAdminPageFramework_Form_View___DebugInfo extends WP_RadarChartAdminPageFramework_FrameworkUtility {
    ...
    public function get() {
        ...
        return "<div class='wp-radar-chart-info'>" . $this->oMsg->get('debug_info') . ': ' . $this->getFrameworkNameVersion() . "</div>";
    }
