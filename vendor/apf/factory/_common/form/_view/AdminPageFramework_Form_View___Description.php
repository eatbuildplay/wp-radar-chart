...
class WP_RadarChartAdminPageFramework_Form_View___Description extends WP_RadarChartAdminPageFramework_FrameworkUtility {
    public $aDescriptions = array();
    public $sClassAttribute = 'wp-radar-chart-form-element-description';
