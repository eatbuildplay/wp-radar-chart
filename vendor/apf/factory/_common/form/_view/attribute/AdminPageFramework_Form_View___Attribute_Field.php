...
abstract class WP_RadarChartAdminPageFramework_Form_View___Attribute_Base extends WP_RadarChartAdminPageFramework_Form_Utility {
    public $sContext = '';
    ...
    abstract class WP_RadarChartAdminPageFramework_Form_View___Attribute_FieldContainer_Base extends WP_RadarChartAdminPageFramework_Form_View___Attribute_Base {
        protected function _getFormattedAttributes() {
    ...
    class WP_RadarChartAdminPageFramework_Form_View___Attribute_Field extends WP_RadarChartAdminPageFramework_Form_View___Attribute_FieldContainer_Base {
        public $sContext = 'field';
        protected function _getAttributes() {
            $_sFieldTypeSelector = $this->getAOrB($this->aArguments['type'], " wp-radar-chart-field-{$this->aArguments['type']}", '');
            ...
            return array('id' => $this->aArguments['_field_container_id'], 'data-type' => $this->aArguments['type'], 'class' => "wp-radar-chart-field{$_sFieldTypeSelector}{$_sNestedFieldSelector}{$_sMixedFieldSelector}{$_sChildFieldSelector}" . $this->getAOrB($this->aArguments['attributes']['disabled'], ' disabled', '') . $this->getAOrB($this->aArguments['_is_sub_field'], ' wp-radar-chart-subfield', ''));
        }
    }
