...
class WP_RadarChartAdminPageFramework_Form_View___Section_Base extends WP_RadarChartAdminPageFramework_Form_Base {
    ...
    public function getFieldsetOutput($aFieldset) {
        ...
        $_oFieldset = new WP_RadarChartAdminPageFramework_Form_View___Fieldset($aFieldset, $this->aSavedData, $this->aFieldErrors, $this->aFieldTypeDefinitions, $this->oMsg, $this->aCallbacks);
        $_sFieldOutput = $_oFieldset->get();
        return $_sFieldOutput;
    }
    }
    class WP_RadarChartAdminPageFramework_Form_View___SectionTitle extends WP_RadarChartAdminPageFramework_Form_View___Section_Base {
        ...
        private function _getToolTip($_aSectionset) {
            ...
            $_oToolTip = new WP_RadarChartAdminPageFramework_Form_View___ToolTip($_aSectionset['tip'], $_sSectionTitleTagID);
        ...
        private function _getDebugInfo($aSectionset) {
            ...
            $_oToolTip = new WP_RadarChartAdminPageFramework_Form_View___ToolTip(array('title' => $this->oMsg->get('section_arguments'), 'dash-icon' => 'dashicons-info', 'icon_alt_text' => '[' . $this->oMsg->get('debug') . ' ]', 'content' => WP_RadarChartAdminPageFramework_Debug::getDetails($aSectionset) . '<span class="wp-radar-chart-info">' . $this->getFrameworkNameVersion() . '  (' . $this->oMsg->get('debug_info_will_be_disabled') . ')' . '</span>', 'attributes' => array('container' => array('class' => 'debug-info-field-arguments'),)), $aSectionset['_section_path'] . '_debug');
            return $_oToolTip->get();
        }
        private function _getCollapseButton($aCollapsible) {
            ...
            return $this->getAOrB('button' === $this->getElement($aCollapsible, 'type', 'box'), "<span class='wp-radar-chart-collapsible-button wp-radar-chart-collapsible-button-expand' title='{$_sExpand}'>&#9658;</span>" . "<span class='wp-radar-chart-collapsible-button wp-radar-chart-collapsible-button-collapse' title='{$_sCollapse}'>&#9660;</span>", '');
        }
        ...
        private function _getFieldsetsInSectionTitleArea(array $aFieldsets, $iSectionIndex, $aFieldTypeDefinitions) {
            ...
            foreach ($aFieldsets as $_aFieldset) {
                ...
                $_oFieldsetOutputFormatter = new WP_RadarChartAdminPageFramework_Form_Model___Format_FieldsetOutput($_aFieldset, $iSectionIndex, $aFieldTypeDefinitions);
    ...
    class WP_RadarChartAdminPageFramework_Form_View___CollapsibleSectionTitle extends WP_RadarChartAdminPageFramework_Form_View___SectionTitle {
        ...
        private function _getCollapsibleSectionTitleBlock(array $aCollapsible, $sContainer = 'sections', $iSectionIndex = null) {
            ...
            return $this->_getCollapsibleSectionsEnablerScript() . "<div " . $this->getAttributes(array('id' => $_sSectionTitleTagID, 'class' => $this->getClassAttribute('wp-radar-chart-section-title', $this->getAOrB('box' === $aCollapsible['type'], 'accordion-section-title', ''), 'wp-radar-chart-collapsible-title', $this->getAOrB('sections' === $aCollapsible['container'], 'wp-radar-chart-collapsible-sections-title', 'wp-radar-chart-collapsible-section-title'), $this->getAOrB($aCollapsible['is_collapsed'], 'collapsed', ''), 'wp-radar-chart-collapsible-type-' . $aCollapsible['type']),) + $this->getDataAttributeArray($aCollapsible)) . ">" . $_sSectionTitle . "</div>";
        }
        ...
        protected function _getCollapsibleSectionsEnablerScript() {
            ...
            self::$_bLoaded = true;
            new WP_RadarChartAdminPageFramework_Form_View___Script_CollapsibleSection($this->oMsg);
        }
    }
