...
class WP_RadarChartAdminPageFramework_Form_View___FieldsetTableRow extends WP_RadarChartAdminPageFramework_Form_View___Section_Base {
    ...
    protected function _getFieldByContainer(array $aFieldset, array $aOpenCloseTags) {
        ...
        $_oFieldTitle = new WP_RadarChartAdminPageFramework_Form_View___FieldTitle($aFieldset, '', $this->aSavedData, $this->aFieldErrors, $this->aFieldTypeDefinitions, $this->aCallbacks, $this->oMsg);
        $_aOutput = array();
    ...
    class WP_RadarChartAdminPageFramework_Form_View___FieldsetRow extends WP_RadarChartAdminPageFramework_Form_View___FieldsetTableRow {
        public $aFieldset = array();
        public $aSavedData = array();
        public $aFieldErrors = array();
        public $aFieldTypeDefinitions = array();
        ...
        public function get() {
            ...
            $_oFieldrowAttribute = new WP_RadarChartAdminPageFramework_Form_View___Attribute_Fieldrow($aFieldset);
