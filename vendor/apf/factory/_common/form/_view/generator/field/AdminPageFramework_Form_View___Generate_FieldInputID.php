...
class WP_RadarChartAdminPageFramework_Form_View___Generate_FieldTagID extends WP_RadarChartAdminPageFramework_Form_View___Generate_Field_Base {
    public function get() {
    ...
    class WP_RadarChartAdminPageFramework_Form_View___Generate_FieldInputID extends WP_RadarChartAdminPageFramework_Form_View___Generate_FieldTagID {
        public $isIndex = '';
