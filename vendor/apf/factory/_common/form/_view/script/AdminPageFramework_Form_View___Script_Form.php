...
class WP_RadarChartAdminPageFramework_Form_View___Script_Form extends WP_RadarChartAdminPageFramework_Form_View___Script_Base {
    static public function getScript() {
        return <<<JAVASCRIPTS
( function( $ ) {

    var _removeWP_RadarChartAdminPageFrameworkLoadingOutputs = function() {

        jQuery( '.wp-radar-chart-form-loading' ).remove();
        jQuery( '.wp-radar-chart-form-js-on' )
            .hide()
            .css( 'visibility', 'visible' )
            .fadeIn( 200 )
            .removeClass( '.wp-radar-chart-form-js-on' );
    ...
    window.onerror = function(){
        ...
        _removeWP_RadarChartAdminPageFrameworkLoadingOutputs();
