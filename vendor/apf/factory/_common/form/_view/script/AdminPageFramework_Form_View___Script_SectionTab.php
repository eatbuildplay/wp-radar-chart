...
class WP_RadarChartAdminPageFramework_Form_View___Script_SectionTab extends WP_RadarChartAdminPageFramework_Form_View___Script_Base {
...
jQuery( '.wp-radar-chart-section-tabs-contents' ).createTabs(); 
});            
JAVASCRIPTS;
        return "<script type='text/javascript' class='wp-radar-chart-section-tabs-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
    }
