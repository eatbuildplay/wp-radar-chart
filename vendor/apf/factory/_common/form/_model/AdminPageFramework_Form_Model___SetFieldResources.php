...
class WP_RadarChartAdminPageFramework_Form_Model___SetFieldResources extends WP_RadarChartAdminPageFramework_Form_Base {
    ...
    private function ___setCommon() {
        ...
        new WP_RadarChartAdminPageFramework_Form_View___Script_RegisterCallback;
        $this->___setCommonFormInternalCSSRules();
    }
    private function ___setCommonFormInternalCSSRules() {
        $_aClassNames = array('WP_RadarChartAdminPageFramework_Form_View___CSS_Form', 'WP_RadarChartAdminPageFramework_Form_View___CSS_Field', 'WP_RadarChartAdminPageFramework_Form_View___CSS_Section', 'WP_RadarChartAdminPageFramework_Form_View___CSS_CollapsibleSection', 'WP_RadarChartAdminPageFramework_Form_View___CSS_FieldError', 'WP_RadarChartAdminPageFramework_Form_View___CSS_ToolTip',);
        foreach ($_aClassNames as $_sClassName) {
            $_oCSS = new $_sClassName;
            $this->aResources['internal_styles'][] = $_oCSS->get();
        }
        $_aClassNamesForIE = array('WP_RadarChartAdminPageFramework_Form_View___CSS_CollapsibleSectionIE',);
    ...
    private function ___setFieldResourcesByFieldTypeDefinition($aFieldset, $_sFieldtype, $_aFieldTypeDefinition) {
        ...
        new WP_RadarChartAdminPageFramework_Form_Model___FieldTypeRegistration($_aFieldTypeDefinition, $this->aArguments['structure_type']);
        $_oFieldTypeResources = new WP_RadarChartAdminPageFramework_Form_Model___FieldTypeResource($_aFieldTypeDefinition, $this->aResources);
