...
class WP_RadarChartAdminPageFramework_Form_Model___Format_RepeatableSection extends WP_RadarChartAdminPageFramework_FrameworkUtility {
    ...
    public function __construct() {
        ...
        $this->_oMsg = $_aParameters[1] ? $_aParameters[1] : WP_RadarChartAdminPageFramework_Message::getInstance();
    }
    public function get() {
    ...
    class WP_RadarChartAdminPageFramework_Form_Model___Format_RepeatableField extends WP_RadarChartAdminPageFramework_Form_Model___Format_RepeatableSection {
        protected function _getDefaultMessage() {
