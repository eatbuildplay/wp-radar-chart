...
class WP_RadarChartAdminPageFramework_Form_Model___FormatSectionset extends WP_RadarChartAdminPageFramework_Form_Utility {
    ...
    public function get() {
        ...
        $_oCollapsibleArgumentFormatter = new WP_RadarChartAdminPageFramework_Form_Model___Format_CollapsibleSection($_aSectionset['collapsible'], $_aSectionset['title']);
