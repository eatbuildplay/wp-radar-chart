...
class WP_RadarChartAdminPageFramework_Form_Model___FormatFieldsets extends WP_RadarChartAdminPageFramework_Form_Base {
    ...
    private function _getDynamicElementsAddedToFieldsets() {
        $_oDynamicElements = new WP_RadarChartAdminPageFramework_Form_Model___FormatDynamicElements($this->aSectionsets, $this->aFieldsets, $this->aSavedData);
    ...
    private function _getFieldsetFormatted($aFieldset, $aSectionsets, $sCapability, $iCountOfElements, $iSubSectionIndex, $bIsSectionRepeatable, $oCallerObject) {
        ...
        $_oFieldsetFormatter = new WP_RadarChartAdminPageFramework_Form_Model___Format_Fieldset($aFieldset, $this->sStructureType, $sCapability, $iCountOfElements, $iSubSectionIndex, $bIsSectionRepeatable, $oCallerObject);
