...
abstract class WP_RadarChartAdminPageFramework_Form_Utility extends WP_RadarChartAdminPageFramework_FrameworkUtility {
    ...
    static public function getFieldsetReformattedBySubFieldIndex($aFieldset, $iSubFieldIndex, $bHasSubFields, $aParentFieldset) {
        ...
        $_oFieldsetFormatter = new WP_RadarChartAdminPageFramework_Form_Model___Format_Fieldset($aFieldset, $aFieldset['_structure_type'], $aFieldset['capability'], ( integer )$iSubFieldIndex + 1, $aFieldset['_subsection_index'], $aFieldset['_is_section_repeatable'], $aFieldset['_caller_object']);
        $aFieldset = $_oFieldsetFormatter->get();
        $_oFieldsetOutputFormatter = new WP_RadarChartAdminPageFramework_Form_Model___Format_FieldsetOutput($aFieldset, $aFieldset['_section_index'], $_oCallerForm->aFieldTypeDefinitions);
    ...
    abstract class WP_RadarChartAdminPageFramework_Form_Base extends WP_RadarChartAdminPageFramework_Form_Utility {
    ...
    class WP_RadarChartAdminPageFramework_Form_Model extends WP_RadarChartAdminPageFramework_Form_Base {
        ...
        public function getSortedInputs(array $aFormInputs) {
            ...
            $_oInputSorter = new WP_RadarChartAdminPageFramework_Form_Model___Modifier_SortInput($aFormInputs, $_aDynamicFieldAddressKeys);
        ...
        public function dropRepeatableElements(array $aSubject) {
            $_oFilterRepeatableElements = new WP_RadarChartAdminPageFramework_Form_Model___Modifier_FilterRepeatableElements($aSubject, $this->getElementAsArray($_POST, '__repeatable_elements_' . $this->aArguments['structure_type']));
        ...
        public function _replyToRegisterFormItems() {
            ...
            $_oFieldResources = new WP_RadarChartAdminPageFramework_Form_Model___SetFieldResources($this->aArguments, $this->aFieldsets, self::$_aResources, $this->aFieldTypeDefinitions, $this->aCallbacks);
        ...
        private function _setSiteWideFieldTypeDefinitions() {
            ...
            $_oBuiltInFieldTypeDefinitions = new WP_RadarChartAdminPageFramework_Form_Model___BuiltInFieldTypeDefinitions('admin_page_framework', $this->oMsg);
        ...
        public function getDefaultFormValues() {
            $_oDefaultValues = new WP_RadarChartAdminPageFramework_Form_Model___DefaultValues($this->aFieldsets);
            return $_oDefaultValues->get();
        }
        protected function _formatElementDefinitions(array $aSavedData) {
            $_oSectionsetsFormatter = new WP_RadarChartAdminPageFramework_Form_Model___FormatSectionsets($this->aSectionsets, $this->aArguments['structure_type'], $this->sCapability, $this->aCallbacks, $this);
            $this->aSectionsets = $_oSectionsetsFormatter->get();
            $_oFieldsetsFormatter = new WP_RadarChartAdminPageFramework_Form_Model___FormatFieldsets($this->aFieldsets, $this->aSectionsets, $this->aArguments['structure_type'], $this->aSavedData, $this->sCapability, $this->aCallbacks, $this);
    ...
    class WP_RadarChartAdminPageFramework_Form_View extends WP_RadarChartAdminPageFramework_Form_Model {
        public function __construct() {
            parent::__construct();
            new WP_RadarChartAdminPageFramework_Form_View__Resource($this);
        }
        public function get() {
        ...
        private function _getNoScriptMessage() {
            ...
            return "<noscript>" . "<div class='error'>" . "<p class='wp-radar-chart-form-warning'>" . $this->oMsg->get('please_enable_javascript') . "</p>" . "</div>" . "</noscript>";
        }
        public function printSubmitNotices() {
            $this->oSubmitNotice->render();
        }
    }
    class WP_RadarChartAdminPageFramework_Form_Controller extends WP_RadarChartAdminPageFramework_Form_View {
    ...
    class WP_RadarChartAdminPageFramework_Form extends WP_RadarChartAdminPageFramework_Form_Controller {
        ...
        public $oFieldError;
        public $oLastInputs;
        public $aSubClasses = array('submit_notice' => 'WP_RadarChartAdminPageFramework_Form___SubmitNotice', 'field_error' => 'WP_RadarChartAdminPageFramework_Form___FieldError', 'last_input' => 'WP_RadarChartAdminPageFramework_Form_Model___LastInput', 'message' => 'WP_RadarChartAdminPageFramework_Message',);
        public function __construct() {
