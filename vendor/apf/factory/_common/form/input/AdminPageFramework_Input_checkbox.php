...
abstract class WP_RadarChartAdminPageFramework_Input_Base extends WP_RadarChartAdminPageFramework_FrameworkUtility {
    public $aField = array();
    public $aAttributes = array();
    public $aOptions = array();
    public $aStructureOptions = array('input_container_tag' => 'span', 'input_container_attributes' => array('class' => 'wp-radar-chart-input-container',), 'label_container_tag' => 'span', 'label_container_attributes' => array('class' => 'wp-radar-chart-input-label-string',),);
    ...
    class WP_RadarChartAdminPageFramework_Input_checkbox extends WP_RadarChartAdminPageFramework_Input_Base {
