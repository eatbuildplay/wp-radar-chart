...
class WP_RadarChartAdminPageFramework_Form___SubmitNotice extends WP_RadarChartAdminPageFramework_FrameworkUtility {
    ...
    public function render() {
        new WP_RadarChartAdminPageFramework_AdminNotice('');
    ...
    private function _printNotices($aNotices) {
        ...
        foreach (array_filter(( array )$aNotices, 'is_array') as $_aNotice) {
            ...
            new WP_RadarChartAdminPageFramework_AdminNotice($this->getElement($_aNotice, 'sMessage'), $this->getElement($_aNotice, 'aAttributes'));
        }
    }
    }
