...
class WP_RadarChartAdminPageFramework_FrameworkUtility extends WP_RadarChartAdminPageFramework_WPUtility {
    ...
    static public function getFrameworkVersion($bTrimDevVer = false) {
        $_sVersion = WP_RadarChartAdminPageFramework_Registry::getVersion();
        return $bTrimDevVer ? self::getSuffixRemoved($_sVersion, '.dev') : $_sVersion;
    }
    static public function getFrameworkName() {
        return WP_RadarChartAdminPageFramework_Registry::NAME;
    }
    static public function getFrameworkNameVersion() {
        return self::getFrameworkName() . ' ' . self::getFrameworkVersion();
    }
    }
    class WP_RadarChartAdminPageFramework_ArrayHandler extends WP_RadarChartAdminPageFramework_FrameworkUtility {
        public $aData = array();
