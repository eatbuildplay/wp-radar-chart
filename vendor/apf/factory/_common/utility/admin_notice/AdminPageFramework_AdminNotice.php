...
class WP_RadarChartAdminPageFramework_AdminNotice extends WP_RadarChartAdminPageFramework_FrameworkUtility {
    ...
    public function __construct($sNotice, array $aAttributes = array('class' => 'error'), array $aCallbacks = array()) {
        ...
        $this->aAttributes['class'] = $this->getClassAttribute($this->aAttributes['class'], 'wp-radar-chart-settings-notice-message', 'wp-radar-chart-settings-notice-container', 'notice', 'is-dismissible');
        $this->aCallbacks = $aCallbacks + $this->aCallbacks;
        new WP_RadarChartAdminPageFramework_AdminNotice___Script;
        if (!$sNotice) {
            return;
        }
