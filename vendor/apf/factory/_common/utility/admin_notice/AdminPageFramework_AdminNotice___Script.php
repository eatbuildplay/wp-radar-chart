...
class WP_RadarChartAdminPageFramework_AdminNotice___Script extends WP_RadarChartAdminPageFramework_Factory___Script_Base {
...
( function( $ ) {
    jQuery( document ).ready( function() {         
        ...
        var _oAdminNotices = jQuery( '.wp-radar-chart-settings-notice-message' );
        if ( _oAdminNotices.length ) {
            ...
            var _oContainer     = jQuery( _oAdminNotices )
                ...
                .wrap( "<div class='wp-radar-chart-admin-notice-animation-container'></div>" );
