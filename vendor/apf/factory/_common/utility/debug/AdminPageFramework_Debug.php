...
class WP_RadarChartAdminPageFramework_Debug_Base extends WP_RadarChartAdminPageFramework_FrameworkUtility {
    ...
    class WP_RadarChartAdminPageFramework_Debug_Log extends WP_RadarChartAdminPageFramework_Debug_Base {
    ...
    class WP_RadarChartAdminPageFramework_Debug extends WP_RadarChartAdminPageFramework_Debug_Log {
        ...
        static public function dumpArray($asArray, $sFilePath = null) {
            self::showDeprecationNotice('WP_RadarChartAdminPageFramework_Debug::' . __FUNCTION__, 'WP_RadarChartAdminPageFramework_Debug::dump()');
            WP_RadarChartAdminPageFramework_Debug::dump($asArray, $sFilePath);
        }
        static public function getArray($asArray, $sFilePath = null, $bEscape = true) {
            self::showDeprecationNotice('WP_RadarChartAdminPageFramework_Debug::' . __FUNCTION__, 'WP_RadarChartAdminPageFramework_Debug::get()');
            return WP_RadarChartAdminPageFramework_Debug::get($asArray, $sFilePath, $bEscape);
        }
        static public function logArray($asArray, $sFilePath = null) {
            self::showDeprecationNotice('WP_RadarChartAdminPageFramework_Debug::' . __FUNCTION__, 'WP_RadarChartAdminPageFramework_Debug::log()');
            WP_RadarChartAdminPageFramework_Debug::log($asArray, $sFilePath);
        }
        static public function getAsString($mValue) {
            self::showDeprecationNotice('WP_RadarChartAdminPageFramework_Debug::' . __FUNCTION__);
