...
abstract class WP_RadarChartAdminPageFramework_Utility_Deprecated {
    static public function minifyCSS($sCSSRules) {
        WP_RadarChartAdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getCSSMinified()');
        return WP_RadarChartAdminPageFramework_Utility_String::getCSSMinified($sCSSRules);
    }
    static public function sanitizeLength($sLength, $sUnit = 'px') {
        WP_RadarChartAdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getLengthSanitized()');
        return WP_RadarChartAdminPageFramework_Utility_String::getLengthSanitized($sLength, $sUnit);
    }
    public static function getCorrespondingArrayValue($vSubject, $sKey, $sDefault = '', $bBlankToDefault = false) {
        WP_RadarChartAdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getElement()');
        if (!isset($vSubject)) {
            return $sDefault;
        }
    ...
    static public function isAssociativeArray(array $aArray) {
        WP_RadarChartAdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__);
    ...
    static public function getAttributes(array $aAttributes) {
        WP_RadarChartAdminPageFramework_Utility::showDeprecationNotice(__METHOD__, 'WP_RadarChartAdminPageFramework_WPUtility::getAttributes()');
        $_sQuoteCharactor = "'";
        $_aOutput = array();
    ...
    abstract class WP_RadarChartAdminPageFramework_Utility_VariableType extends WP_RadarChartAdminPageFramework_Utility_Deprecated {
    ...
    abstract class WP_RadarChartAdminPageFramework_Utility_String extends WP_RadarChartAdminPageFramework_Utility_VariableType {
    ...
    abstract class WP_RadarChartAdminPageFramework_Utility_Array extends WP_RadarChartAdminPageFramework_Utility_String {
    ...
    abstract class WP_RadarChartAdminPageFramework_Utility_ArrayGetter extends WP_RadarChartAdminPageFramework_Utility_Array {
    ...
    abstract class WP_RadarChartAdminPageFramework_Utility_ArraySetter extends WP_RadarChartAdminPageFramework_Utility_ArrayGetter {
    ...
    abstract class WP_RadarChartAdminPageFramework_Utility_Path extends WP_RadarChartAdminPageFramework_Utility_ArraySetter {
    ...
    abstract class WP_RadarChartAdminPageFramework_Utility_URL extends WP_RadarChartAdminPageFramework_Utility_Path {
    ...
    abstract class WP_RadarChartAdminPageFramework_Utility_File extends WP_RadarChartAdminPageFramework_Utility_URL {
    ...
    abstract class WP_RadarChartAdminPageFramework_Utility_SystemInformation extends WP_RadarChartAdminPageFramework_Utility_File {
    ...
    abstract class WP_RadarChartAdminPageFramework_Utility_HTMLAttribute extends WP_RadarChartAdminPageFramework_Utility_SystemInformation {
    ...
    class WP_RadarChartAdminPageFramework_Utility extends WP_RadarChartAdminPageFramework_Utility_HTMLAttribute {
