...
class WP_RadarChartAdminPageFramework_Property_post_meta_box extends WP_RadarChartAdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sClassName, $sCapability = 'edit_posts', $sTextDomain = 'wp-radar-chart', $sStructureType = 'post_meta_box') {
