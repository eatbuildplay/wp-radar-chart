...
abstract class WP_RadarChartAdminPageFramework_MetaBox_Router extends WP_RadarChartAdminPageFramework_Factory {
    public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'wp-radar-chart') {
    ...
    abstract class WP_RadarChartAdminPageFramework_MetaBox_Model extends WP_RadarChartAdminPageFramework_MetaBox_Router {
        public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'wp-radar-chart') {
        ...
        public function _replyToGetSavedFormData() {
            $_oMetaData = new WP_RadarChartAdminPageFramework_MetaBox_Model___PostMeta($this->_getPostID(), $this->oForm->aFieldsets);
    ...
    abstract class WP_RadarChartAdminPageFramework_MetaBox_View extends WP_RadarChartAdminPageFramework_MetaBox_Model {
    ...
    abstract class WP_RadarChartAdminPageFramework_MetaBox_Controller extends WP_RadarChartAdminPageFramework_MetaBox_View {
    ...
    abstract class WP_RadarChartAdminPageFramework_MetaBox extends WP_RadarChartAdminPageFramework_MetaBox_Controller {
