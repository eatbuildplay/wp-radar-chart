...
abstract class WP_RadarChartAdminPageFramework_PluginBootstrap {
    public $sFilePath;
    public $bIsAdmin;
    public $sHookPrefix;
    ...
    protected function _registerClasses() {
        if (!class_exists('WP_RadarChartAdminPageFramework_RegisterClasses', false)) {
            return;
        }
        new WP_RadarChartAdminPageFramework_RegisterClasses($this->getScanningDirs(), array(), $this->getClasses());
    }
