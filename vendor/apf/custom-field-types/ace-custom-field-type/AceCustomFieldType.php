<?php
/**
 * WP_RadarChartAceCustomFieldType, for the  Admin Page Framework by Michael Uno, is written by Per Soderlind - http://soderlind.no
 */
if ( ! class_exists( 'WP_RadarChartAceCustomFieldType' ) ) :
class WP_RadarChartAceCustomFieldType extends WP_RadarChartAdminPageFramework_FieldType {
            ...
            jQuery().registerAPFCallback( {
                ...
                */
                added_repeatable_field: function( oCopied, sFieldType, sFieldTagID, iCallType ) {
                    ...
                    oCopied.closest( '.wp-radar-chart-field' ).nextAll().andSelf().each( function( iIndex ) {
    ...
    public function getField( $aField ) {
        ...
        return
            $aField['before_label']
            . "<div class='wp-radar-chart-input-label-container'>"
